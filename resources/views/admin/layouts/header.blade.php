											...
											<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
												...
												<div class="message-menu ps2 overflow-hidden">
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ asset('admin/assets/images/users/1.jpg') }}" style="background: url({{ asset('admin/assets/images/users/1.jpg') }}) center center;"></span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ asset('admin/assets/images/users/15.jpg') }}" style="background: url({{ asset('admin/assets/images/users/15.jpg') }}) center center;">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ asset('admin/assets/images/users/12.jpg') }}" style="background: url({{ asset('admin/assets/images/users/12.jpg') }}) center center;">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
													...
													<a class="dropdown-item d-flex" href="chat.html">
														<span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{ asset('admin/assets/images/users/4.jpg') }}" style="background: url({{ asset('admin/assets/images/users/4.jpg') }}) center center;">
														</span>
														<div class="wd-90p">
															<div class="d-flex">
